"""The Aviary class, the core of how PersonFollower handles UAVs in the PyBullet simulation environment."""
...
from PersonFollower.core.abstractions import DroneClass, WindFieldClass
from PersonFollower.core.drones import Fixedwing, QuadX, Rocket
...
class Aviary(bullet_client.BulletClient):
    """Aviary class, the core of how PersonFollower handles UAVs in the PyBullet simulation environment.
